...
CONFIG = {
    # Source: Your MAM downloads folder
    "source_folder": r"C:\TOOLS-LAPTOP\Projects\MAM Project\Downloads",
    
    # Destination: Your organized library folder
    "destination_folder": r"C:\TOOLS-LAPTOP\Projects\MAM Project\Organized",
    
    # Database file to track processed items (prevents re-processing)
    "database_file": r"C:\TOOLS-LAPTOP\Projects\MAM Project\mam_organizer.db.json",
    
    # Log file location
    "log_file": r"C:\TOOLS-LAPTOP\Projects\MAM Project\mam_organizer.log",
